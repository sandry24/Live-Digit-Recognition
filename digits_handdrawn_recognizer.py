...
data_augmentation = keras.Sequential([
    tf.keras.layers.RandomZoom(0.2, input_shape=(target_image_size[0], target_image_size[1], 3)),
...
# Define the Callback
checkpoint = ModelCheckpoint("Model(ResNet50)_digits_handdrawn_plus.h5", monitor='val_accuracy', verbose=1, save_best_only=True,
...
# Save the model
# model.save('saved_models/resnet50_mushrooms')
